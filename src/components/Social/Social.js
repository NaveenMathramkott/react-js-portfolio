    ...
    return (
      <div className={classes.mobileWrapper}>
        <IconBtn
          icon={GitHub}
          m={1}
          href="https://github.com/NaveenMathramkott"
        />
        <IconBtn
          icon={Instagram}
          m={1}
          href="http://instagram.com/naveen_mathramkott"
        />
        <IconBtn
          icon={LinkedIn}
          m={1}
          href="http://linkedin.com/in/naveenmathramkott"
        />
        <IconBtn icon={Email} m={1} href="mailto:naveenmathramkott@gmail.com" />
      </div>
    );
  } else {
    return (
      <motion.div className={classes.wrapper}>
        ...
        <motion.div animate={controls} custom={3}>
          <IconBtn
            icon={Email}
            m={1}
            href="mailto:naveenmathramkott@gmail.com"
          />
        </motion.div>
